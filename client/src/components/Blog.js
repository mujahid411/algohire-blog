            ...
            <div className="max-w-screen-xl mx-auto md:px-8">
                <div className="items-center gap-x-10 sm:px-0 md:px-0 lg:flex">
                    ...
                    <div className="max-w-xl px-3 space-y-3 mt-0 sm:px-0 md:mt-0 lg:max-w-2xl">
                        ...
                        <p className="text-black text-3xl font-semibold sm:text-4xl text-left">
                            {title}
                        </p>
                        ...
                        <a href={`/singleBlog/${id}`} className="inline-flex gap-x-1 items-center font-medium text-indigo-600">
                            Read more
