    ...
    return (
        <div className='bg-white h-screen'>
            <header className='bg-white'>
                ...
                <nav className="items-center pt-5 px-4 mx-auto max-w-screen-xl sm:px-8 md:flex md:space-x-6 bg-white">
                    <div className="flex justify-between items-center w-full">
                        ...
                        <ul className={`flex-1 justify-between mt-12 md:flex md:mt-0 ${state ? '' : 'hidden'}`}>
                            <li className="order-2 pb-5 md:pb-0 ml-auto">
                                <a href="/login" className="py-3 px-6 rounded-md shadow-md text-center bg-indigo-500 text-white focus:shadow-none block md:inline">
                                    Sign In
                                </a>
                            </li>
                        </ul>
            ...
            <section className="mt-24 mx-auto max-w-screen-xl pb-4 px-4 sm:px-8 bg-white">
                <div className="text-center space-y-4">
                    ...
                    <p className="max-w-xl mx-auto leading-relaxed text-black">
                ...
                <div className="mt-12 justify-center items-center space-y-3 sm:space-x-6 sm:space-y-0 sm:flex">
                    <a href="/main" className="px-10 py-3.5 w-full bg-black text-white text-center rounded-md shadow-md block sm:w-auto">
                        Explore Blogs
                    </a>
